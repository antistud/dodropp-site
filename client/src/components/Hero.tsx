        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              DoDropp turns boring to-do lists into magical, self-organizing adventures! ✨ Share one link with your friends, set up powerful automations, and watch your group tasks complete themselves - from game nights to road trips!
            </p>
